...
render-markdown, todo-comments, undotree, gitsigns, snacks lazygit, nvim-emmet. These
reproduce prototype screens 2 (editing/statusline/bufferline/gitsigns/fold),
8 (which-key), 10 (snacks lazygit + inline blame), 11 (undotree), 12 (render-markdown).
...
- [x] gitsigns shows add/change/delete signs + inline blame; snacks lazygit runs raw
