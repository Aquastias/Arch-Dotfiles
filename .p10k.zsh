# Generated by Powerlevel10k configuration wizard on 2025-06-06 at 00:00 EEST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color (Arch blue).
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=39
  # Arch logo glyph (powerline mode doesn't auto-pick the nerd OS glyph).
